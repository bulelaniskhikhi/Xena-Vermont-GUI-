  ...
  <div style="padding-top: 20vh">
    <div class="container" v-if="product">
        ...
        <div class="col-lg-6 col-sm-12 col-md-12">
          <div style="display: flex; justify-content: center; color: red">
            <div>
              ...
              <p>
                <strong>Alternative Titles: </strong><em>{{ product.romajiTitle }}, {{ product.kanjiTitle }}</em>
              </p>
              ...
              <div class="row">
                <div class="col-6">
                  ...
                  <p style="display: flex; justify-content: space-between">
                    <strong>Realise Date: </strong> <em>{{ product.realisedDate }}</em>
                  </p>

                  <p style="display: flex; justify-content: space-between">
                    <strong>Serial Code: </strong
                    ><em>{{ product.serialCode }}</em>
                  </p>

                  <p style="display: flex; justify-content: space-between">
                    <strong>Developer: </strong><em>{{ product.studioDev }}</em>
                  </p>

                  <p style="display: flex; justify-content: space-between">
                    <strong>Publisher: </strong><em>{{ product.studioPub }}</em>
                  </p>

                  <p style="display: flex; justify-content: space-between">
                    <strong>Price: </strong><em>R{{ product.priceRands }}</em>
                  </p>

                  <p style="display: flex; justify-content: space-between">
                    <strong>Price: </strong><em>¥{{ product.priceYens }}</em>
                  </p>
      ...
      <div class="row" style="margin-bottom: 3rem; margin-top: 3rem">
        ...
        <div class="col-lg-6 col-sm-12 col-md-12" style=" display: flex; align-items: center; justify-content: center; margin-bottom: 5rem;padding: 30px;">
...
.book::before {
  ...
  position: absolute;
  transform: translateX(calc(245px - 50px / 2 - 3px)) rotateY(90deg)
